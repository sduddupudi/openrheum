...
?>
     ...
     <div id="main-wrapper">
        ...
        <div id="breakout_5" class="right_content" style="background-image: url(assets/images/conf_5.png);">
        <?php if($row_lobby['breakout_5_appears'] == 'yes') {?>                  
            <div class="icon_div video_confrence">
                <span><img src="assets/images/Icone_videoconference.png"></span>
                
                <div class="icon_div_hover">
                    <a href="<?php if(isset($row_lobby['breakout5_join_video_conference'])){echo $row_lobby['breakout5_join_video_conference']; } ?>" target="_blank">
                        <img src="assets/images/Icone_videoconference.png">
                        <p><?php if(isset($row_lobby['ihd_cosentyx_pso_btn_text'])){echo $row_lobby['ihd_cosentyx_pso_btn_text']; } ?></p>
                    </a>
                </div>
            </div>
        <?php } ?>    
