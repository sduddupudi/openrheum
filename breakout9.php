...
?>
     <div id="main-wrapper">
        ...
        <div id="breakout_9" class="right_content" style="background-image: url(assets/images/conf_9.png);">
        <?php if($row_lobby['breakout_9_appears'] == 'yes') {?>                  
            <div class="icon_div video_confrence">
                <span><img src="assets/images/Icone_videoconference.png"></span>
                
                <div class="icon_div_hover">
                    <a href="<?php if(isset($row_lobby['breakout9_join_video_conference'])){echo $row_lobby['breakout9_join_video_conference']; } ?>" target="_blank">
                        <img src="assets/images/Icone_videoconference.png">
                        <p><?php if(isset($row_lobby['neuroscience_ms_btn_text'])){echo $row_lobby['neuroscience_ms_btn_text']; } ?></p>
                    </a>
                </div>
            </div>
        <?php } ?>    
