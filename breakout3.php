...
<div id="main-wrapper">
    <div class="sidebar-main">
        ...
        <?php if($row_lobby['footer_hyperlink_text_appears'] == 'no'){ ?>
    ...
    <div id="breakout_3" class="right_content" style="background-image: url(assets/images/conf_2.jpg);">
        <?php if($row_lobby['breakout_3_appears'] == 'yes') {?>
        <div class="icon_div breakout3_icon">
            <span><img src="assets/images/Icone_videoconference.png"></span>

            <div class="icon_div_hover">
                <a href="<?php if(isset($row_lobby['breakout3_join_video_conference'])){echo $row_lobby['breakout3_join_video_conference']; } ?>"
                    target="_blank">
                    <img src="assets/images/Icone_videoconference.png">
                    <p><?php if(isset($row_lobby['respiratory_btn_text'])){echo $row_lobby['respiratory_btn_text']; } ?>
                    </p>
                </a>
            </div>
        </div>
