...
<div id="main-wrapper">
    ...
    <div id="breakout_2" class="right_content" style="background-image: url(assets/images/conf_9.png);">
        <?php if($row_lobby['breakout_2_appears'] == 'yes') {?>
        <div class="icon_div breakout2_icon">
            <span><img src="assets/images/Icone_videoconference.png"></span>

            <div class="icon_div_hover">
                <a href="<?php if(isset($row_lobby['breakout2_join_video_conference'])){echo $row_lobby['breakout2_join_video_conference']; } ?>"
                    target="_blank">
                    <img src="assets/images/Icone_videoconference.png">
                    <p><?php if(isset($row_lobby['gp2_btn_text'])){echo $row_lobby['gp2_btn_text']; } ?></p>
                </a>
            </div>
        </div>
        <?php } ?>
